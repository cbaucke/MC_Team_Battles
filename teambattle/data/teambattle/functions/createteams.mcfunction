...
# Random teams
execute if score options randTeams matches 1 run function teambattle:assignteams
execute if score options randTeams matches 1 run schedule function teambattle:setup 5s append
...
execute if score options randTeams matches 0 run function teambattle:chooseteams