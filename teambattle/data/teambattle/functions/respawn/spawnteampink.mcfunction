...
execute unless entity @p[team=Pink, tag=Leader, distance=20..] run tellraw @s {"text":"Team leader dead or not found, try again later."}
execute unless entity @p[team=Pink, tag=Leader, distance=20..] run return 0
...
tp @s @p[team=Pink, tag=Leader, distance=20..]