...
setblock ~ ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:iron_ingot 3"}

summon minecraft:armor_stand ~-1 ~12 ~5 
setblock ~-1 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:oak_wood 6"}

summon minecraft:armor_stand ~-2 ~12 ~5 
setblock ~-2 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:bookshelf 1"}

summon minecraft:armor_stand ~-3 ~12 ~5 
setblock ~-3 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:arrow 12"}
...
setblock ~-5 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:cooked_beef 5"}

summon minecraft:armor_stand ~-6 ~12 ~5 
setblock ~-6 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:fishing_rod 1"}
...
setblock ~-9 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:torch 24"}

summon minecraft:armor_stand ~-10 ~12 ~5 
setblock ~-10 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:diamond 1"}

summon minecraft:armor_stand ~-11 ~12 ~5 
setblock ~-11 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:scaffolding 16"}
...
setblock ~-13 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:emerald 3"}
...
setblock ~-15 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:coal 8"}

summon minecraft:armor_stand ~-16 ~12 ~5 
setblock ~-16 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:string 6"}
...
setblock ~-20 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:wolf_spawn_egg 1"}

summon minecraft:armor_stand ~-21 ~12 ~5 
setblock ~-21 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:experience_bottle 6"}

summon minecraft:armor_stand ~-22 ~12 ~5 
setblock ~-22 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:cobblestone 32"}

summon minecraft:armor_stand ~-23 ~12 ~5 
setblock ~-23 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:hay_block 3"}
...
setblock ~-25 ~11 ~3 command_block[facing=north]{Command:"give @a[tag=RandItem] minecraft:spruce_boat 1"}